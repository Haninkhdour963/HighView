    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="form-container">
                ...
                <form action="/superadmin/create" method="POST" class="needs-validation" novalidate>
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="building_num" name="building_num" placeholder="Building Number">
